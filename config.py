...
__C.DATASETS.SHAPENET.PARTIAL_POINTS_PATH        = '/content/drive/MyDrive/grnet-shapenet-pretrained-model/dataset/%s/partial/%s/%s/%02d.pcd'
__C.DATASETS.SHAPENET.COMPLETE_POINTS_PATH       = '/content/drive/MyDrive/grnet-shapenet-pretrained-model/dataset/%s/complete/%s/%s.pcd'
