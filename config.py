...
__C.DATASETS.SHAPENET.PARTIAL_POINTS_PATH        = '/content/drive/MyDrive/grnet-shapenet-pretrained-model/dataset/test/partial/%s/%s/%s/%s.pcd'
__C.DATASETS.SHAPENET.COMPLETE_POINTS_PATH       = '/content/drive/MyDrive/grnet-shapenet-pretrained-model/dataset/test/complete/%s/%s/%s.pcd'
